      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="font-serif text-2xl font-bold italic mb-4">
              Baran Atay <span className="text-primary-300">Hair Art</span>
            </h3>
            <p className="text-gray-400 max-w-md">
              Modern saç tasarımı ve premium kuaför deneyimi. Kişiye özel hizmet ve
              kaliteli ürünlerle tarzınızı yansıtın.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#anasayfa" className="text-gray-400 hover:text-white transition-colors">
                  Anasayfa
                </a>
              </li>
              <li>
                <a href="#hizmetler" className="text-gray-400 hover:text-white transition-colors">
                  Hizmetler
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Baran Atay Hair Art. Tüm hakları saklıdır.
            </p>
